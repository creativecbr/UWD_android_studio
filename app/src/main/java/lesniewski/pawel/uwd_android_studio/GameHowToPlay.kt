...
class GameHowToPlay : Fragment(R.layout.fragment_game_how_to_play), IFragmentChanger
{
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.fragment_game_how_to_play, container, false)
